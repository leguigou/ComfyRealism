...
- **Privacy & Portability**: NEVER hardcode personal domains or infrastructure details in the source code. Always use dynamic detection or environment variables. Anonymize logs and comments if necessary.
